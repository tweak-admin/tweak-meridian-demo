...
function HeroIllustration() {
  return (
    <div className="relative mx-auto w-full max-w-5xl">
      ...
      <div className="absolute inset-x-12 -top-8 h-32 rounded-full bg-gray-200 opacity-50 blur-3xl" />
      ...
      <div className="relative overflow-hidden rounded-2xl border border-gray-200 bg-white card-shadow-lg">
        ...
        <div className="flex h-10 items-center gap-2 border-b border-gray-100 bg-gray-50 px-4">
          ...
          <div className="h-3 w-3 rounded-full bg-gray-300" />
          <div className="h-3 w-3 rounded-full bg-gray-300" />
          <div className="ml-3 h-5 w-64 rounded-md bg-gray-200" />
        </div>

        {/* App shell */}
        <div className="flex h-[420px] overflow-hidden sm:h-[480px]">
          {/* Sidebar */}
          <div className="hidden w-52 shrink-0 border-r border-gray-100 bg-gray-50 sm:block">
            <div className="p-4">
                  ...
                  >
                    <div
                      className={`h-4 w-4 rounded ${
                        i === 0 ? 'bg-gray-600' : 'bg-gray-200'
                      }`}
                    />
                    <div
                      className={`h-3 rounded ${
                        i === 0 ? 'w-16 bg-gray-500' : 'w-12 bg-gray-200'
                      }`}
                    />
                  </div>
                ))}
          ...
          <div className="flex-1 overflow-hidden bg-white p-5">
            ...
            <div className="mb-5 flex items-center justify-between">
              <div>
                <div className="mb-1.5 h-5 w-28 rounded bg-gray-800" />
            ...
            <div className="mb-5 grid grid-cols-3 gap-3">
              {[
                ...
                <div key={i} className="rounded-xl border border-gray-100 bg-white p-3 card-shadow">
                  <div className={`mb-2.5 h-1 w-6 rounded-full ${card.accent}`} />
                  <div className="mb-1.5 h-5 w-16 rounded bg-gray-800" />
            ...
            {/* Chart area */}
            <div className="mb-4 rounded-xl border border-gray-100 bg-white p-4 card-shadow">
            ...
            <div className="space-y-2">
              {[80, 65, 90].map((w, i) => (
                <div key={i} className="flex items-center gap-3">
                  ...
                  <div className="ml-auto h-3 rounded bg-gray-100" style={{ width: `${w}px` }} />
...
export function Hero() {
  return (
    <div className="relative overflow-hidden bg-[#F9F8F6] gradient-mesh pt-16">
      {/* Subtle grid pattern */}
      <div
      ...
      <Container>
        <div className="pb-16 pt-20 text-center lg:pt-28">
          ...
          <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-gray-200 bg-white px-5 py-1.5">
          ...
          <h1 className="text-balance mx-auto max-w-4xl text-5xl font-bold tracking-tight text-gray-900 sm:text-6xl lg:text-6xl">
            The workspace that{' '}
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
            ...
            <Button variant="ghost" size="lg" className="border border-gray-200 text-gray-700">
              <svg
                width="16"
                height="16"
                viewBox="0 0 16 16"
      ...
      {/* Bottom fade */}
      <div className="pointer-events-none absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-[#F9F8F6] to-transparent" />
    </div>
  )
}
